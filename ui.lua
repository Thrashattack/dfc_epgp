...
local function CreateEPGPFrameStandings()
  ...
  local min_epgp_filter = CreateFrame("CheckButton", nil, f, "UICheckButtonTemplate")
  min_epgp_filter:SetWidth(20)
  min_epgp_filter:SetHeight(20)
  min_epgp_filter:SetPoint("LEFT", f, "LEFT", -24, 0)
  min_epgp_filter:SetScript(
    "OnShow",
    function(self)
      self:SetChecked(EPGP:StandingsHideMinEPGP())
    end)
  min_epgp_filter:SetScript(
    "OnClick",
    function(self)
      EPGP:StandingsHideMinEPGP(not not self:GetChecked())
    end)
  local min_epgp_label = min_epgp_filter:CreateFontString(nil, "ARTWORK", "GameFontHighlightSmall")
  min_epgp_label:SetText("Hide min epgp")
  min_epgp_label:SetPoint("RIGHT", min_epgp_filter, "LEFT", 0, 2)
  f:SetWidth(min_epgp_label:GetStringWidth() + 4 * tl:GetWidth() + cb:GetWidth())
